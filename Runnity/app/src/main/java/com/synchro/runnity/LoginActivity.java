...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Singleton.getInstance().initRealm();
        realm = Realm.getDefaultInstance();
        populateAutoComplete();
        SharedPreferences sharedPreferences = getSharedPreferences("runit", MODE_PRIVATE);
...
//    public void getUser(JsonObject jsonUser) {
//        if (jsonUser == null)
//            return;
//        realm = Realm.getDefaultInstance();
//        User user = null;
//        if (jsonUser.get("email") != null) {
//            user = realm.where(User.class).equalTo("email", jsonUser.get("email").getAsString()).findFirst();
//            if (user == null) {
