...
public class EventWallActivity extends AppCompatActivity {
    private Posts posts;
...
//                            return;
        ...
        pictureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MultiImageSelector.create(getApplicationContext())
                        ...
                        .start(EventWallActivity.this, 0);
            }
        });
    ...
    public void getPosts() {
        String url = getString(R.string.api_url) + "events/" + eventId + "/posts";
